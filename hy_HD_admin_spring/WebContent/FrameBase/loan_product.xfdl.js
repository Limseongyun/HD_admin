(function()
{
    return function()
    {
        ...
        this.myload = function(obj,e){
        	var id = "urlTest01";
        	var url = "http://192.168.0.18:8080/nextest/all";
        	var reqDs = "";
        ...
        this.addlp = function(obj,e)
        {
        	...
        	var id = "urlTest01";
        	var url = "http://192.168.0.18:8080/nextest/lpAdd?lp_name="+lp_name+"&lp_interestrate="+lp_interestrate
        ...
        this.searchbtn = function(obj,e)
        {
        	...
        	var id = "urlTest03";
        	var url = "http://192.168.0.18:8080/nextest/search?searchtype="+searchtype+"&searchvalue="+searchvalue;
        	var reqDs = "";
        	var respDs = " loan_pd=ar"; //데이터 셋을 response
        	var args = "";
        	var callback = "received";
        ...
        this.dellp = function(obj,e)
        {
        	...
        	var id = "urlTest01";
        	var url = "http://192.168.0.18:8080/nextest/lpdel?lp_num="+lp_num;
        	var reqDs = "";
        	var respDs = "";
        	var args = "";
        	var callback = "myload";
