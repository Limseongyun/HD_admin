...
if (nexacro._Browser != "Runtime" && !nexacro.Element) {
	...
	if ((nexacro._Browser == "IE" && nexacro._BrowserVersion == 9) || (nexacro._Browser == "Edge" && nexacro._BrowserType == "Edge") || nexacro._OS == "iOS") {
	...
	_pInputElement.on_sys_keypress_process = function (evt) {
		...
		if (_win && _win._keydown_element && nexacro._Browser == "Gecko") {
			if (_win._keydown_element !== pThis && ((!comp._grid && comp._processing_autoskip) || (comp._grid && !comp._processing_autoskip))) {
